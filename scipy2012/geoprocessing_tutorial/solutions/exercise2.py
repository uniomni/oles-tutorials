...
def calculate_polygon_area(polygon, signed=False):
    ...
    # Get number of coordinates (assuming polygon is closed)
    N = len(P) - 1

    # Exercise: Compute A as shown in http://paulbourke.net/geometry/polyarea
    A = 0.0
    for i in range(N):
...
if __name__ == '__main__':
    ...
    print 'All areas computed correctly - well done!'
