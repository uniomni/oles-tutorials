...
def calculate_polygon_centroid(polygon):
    ...
    # Exercise: Compute C as shown in the slides
    
    
    # Code here to establish the centroid longitude (Cx) and the latitude (Cy)
...
if __name__ == '__main__':
    ...
    print 'All centroids computed correctly!'
