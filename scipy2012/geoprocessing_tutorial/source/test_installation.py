...
from utilities import ugettext as tr, unique_filename
from clipping import clip_raster_by_polygons

from polygon import (is_inside_polygon, inside_polygon,
                     populate_polygon,
                     generate_random_points_in_bbox)

from utilities import BoundingBoxError, ReadLayerError
from utilities import VerificationError, InaSAFEError
from utilities import TESTDATA
from utilities import FEATURE_COUNTS
from utilities import GEOTRANSFORMS
from interpolation2d import interpolate2d, interpolate_raster
from interpolation2d import BoundsError
from interpolation1d import interpolate1d
from utilities import combine_coordinates
from utilities import nanallclose

from geodesy import Point

HAZDATA = EXPDATA = TESTDATA  #, DATADIR
...
class Test_IO(unittest.TestCase):
    ...
    def setUp(self):
        """ Variables used by geodesy tests
        """
    ...
    def test_multipart_polygon_can_be_read(self):
        ...
        filename = ('%s/rw_jakarta.shp' % TESTDATA)
